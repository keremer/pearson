...
class TestAPIRoutes:
    ...
    def test_api_courses_with_data(self, client, db_session):
        ...
        portal.tests.conftest.create_test_course(db_session, title='API Course 1')
        portal.tests.conftest.create_test_course(db_session, title='API Course 2')
    ...
    def test_api_course_lessons(self, client, db_session):
        ...
        course = portal.tests.conftest.create_test_course(db_session)
        portal.tests.conftest.create_test_lesson(db_session, course.id, title='Lesson 1', order=1)
        portal.tests.conftest.create_test_lesson(db_session, course.id, title='Lesson 2', order=2)
